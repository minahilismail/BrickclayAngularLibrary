# Minahil Library Schematics

This directory contains Angular schematics for the Minahil library, providing automated setup and installation.
...
ng add minahil
# Output:
# ❌ Minahil library supports Angular versions 17-21, but found Angular 22.
...
| Feature                 | Angular Material | Minahil |
| ----------------------- | ---------------- | ------- |
